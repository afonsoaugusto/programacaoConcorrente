...
public class Consumidor implements Runnable{
    ...
    @Override
    public void run() {
    	Log.getLogger(this.getClass()).info("Inicio da thread"+" "+Thread.currentThread().getId()+" "+Calendar.getInstance().getTime());
		...
		while(next != null){
            try {
                ...
                Log.includeLogFile(this.execution,id, file.getName(), new Date());
